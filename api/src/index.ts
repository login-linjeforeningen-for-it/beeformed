...
import { startUserCleanup } from './utils/cleanup/userCleanup.ts'
import { startFormCleanup } from './utils/cleanup/formCleanup.ts'
...
async function main() {
    try {
        ...
        await startUserCleanup()
        await startFormCleanup()
    } catch (err) {
